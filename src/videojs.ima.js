...
(function(vjs) {
  ...
  var ImaPlugin = function(player, options, readyCallback) {
     ...
     * @private
     */
    var onContentPauseRequested_ = function(adEvent) {
      this.adsActive = true;
      this.adPlaying = true;
     ...
     * @private
     */
    var onContentResumeRequested_ = function(adEvent) {
   ...
   var onAdLoaded_ = function(adEvent) {
     ...
     * @private
     */
    var onAdComplete_ = function(adEvent) {
      if (this.currentAd.isLinear()) {
    ...
    if (!readyCallback) {
      readyCallback = this.startFromReadyCallback.bind(this);
    }
