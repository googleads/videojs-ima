...
(function(vjs) {
  ...
  var extend = function(obj) {
    ...
    imaPlugin = function(options, readyCallback) {
      ...
      /**
       * Configuration. Query whether option "isResponsive" is set or not.
       * Replaces fixed values by relative values
       */


      player.ima.getWidth_ = function () {
        if (settings.isResponsive) {
          return '100%';
        }

        return player.width() + 'px';
      },

        player.ima.getHeight_ = function () {
          if (settings.isResponsive) {
            return '100%';
          }
       ...
       */
        player.ima.createAdContainer_ = function() {
          ...
          adContainerDiv.style.width = player.ima.getWidth_();
          adContainerDiv.style.height = player.ima.getHeight_();
      ...
      player.ima.createControls_ = function() {
        ...
        seekBarDiv.style.width = player.ima.getWidth_();
      ...
      player.ima.requestAds = function() {
        ...
        adsRequest.linearAdSlotWidth = player.ima.getWidth_();
        adsRequest.linearAdSlotHeight = player.ima.getHeight_();
        adsRequest.nonLinearAdSlotWidth =
          settings.nonLinearWidth || player.ima.getWidth_();
        adsRequest.nonLinearAdSlotHeight =
          settings.nonLinearHeight || (player.ima.getHeight_() / 3);
      ...
      player.ima.start = function() {
        try {
          adsManager.init(
            player.ima.getWidth_(),
            player.ima.getHeight_(),
